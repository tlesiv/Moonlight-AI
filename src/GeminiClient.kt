...
suspend fun callGeminiStream(
    ...
    val systemPrompt = """
        ...
        Твої правила:
        1. Будь максимально ввічливим але відвертим, не хами.
        ...
        5. Використовуй маркований список але не так багато(лише якщо якісь перечислення, наприклад переваги та недоліки, перечислення).
    """.trimIndent()
